...
# fichiers sources
SRCS = src/main.c src/prompt.c src/pwd.c src/cd.c src/exit.c src/ftype.c src/ls.c src/cat.c src/redirections/redirection.c src/redirections/redir_stdout.c src/external_cmds.c src/cmd_utils.c 
